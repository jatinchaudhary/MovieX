...
part 'generated_files/movie_detailed_response_model.g.dart';

@JsonSerializable(createToJson: false)
class MovieDetailedResponseModel {
    ...
    factory MovieDetailedResponseModel.fromJson(Map<String, dynamic> json) => _$MovieDetailedResponseModelFromJson(json);
